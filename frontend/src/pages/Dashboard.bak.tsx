        ...
        <div className="space-y-10 animate-in fade-in duration-500">
            ...
            <div className="flex items-center justify-between pb-2">
                ...
                <div className="flex space-x-2">
                    <div className="bg-white px-4 py-2 rounded-lg border border-gray-200 text-xs font-bold text-gray-400 uppercase tracking-widest shadow-sm">
                        Live Monitor
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                    ...
                    { label: 'Unique Issues', value: metrics?.unique_issues },
                    { label: 'Top Rule Failure', value: metrics?.most_frequent, sub: true },
                    { label: 'Recent Ingestion', value: metrics?.last_incident },
                ].map((m, i) => (
                    <div key={i} className="bg-white p-6 rounded-2xl border border-border shadow-sm hover:shadow-md transition-all">
                        <div className="flex justify-between items-start mb-2">
                            <p className="text-sm font-bold text-text-muted uppercase tracking-tight">{m.label}</p>
                        </div>
                        <p className={cn("font-black text-text-primary truncate", m.sub ? "text-sm mt-3 text-text-secondary" : "text-4xl mt-1")}>
                            {m.value || '0'}
                        </p>
                    </div>
                ))}
                    ...
                    <div className="p-8 border-b border-gray-50 flex items-center justify-between bg-white/50 backdrop-blur-md">
                        <div className="flex items-center gap-4">
                            ...
                            <button
                                ...
                                className="px-4 py-2 bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white text-sm font-bold rounded-lg shadow-md transition-all flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                {isAnalyzing ? (
                                    <>
                                    ...
                                    <>
                                        <span>✨ Analyse Top 5 Errors</span>
                                    </>
                                )}
                            </button>
                        </div>
                    ...
                    <div className="overflow-x-auto max-h-[600px] custom-scrollbar">
                        <table className="w-full text-left border-collapse">
                            <thead className="sticky top-0 bg-white/95 backdrop-blur-sm z-10 shadow-sm border-b border-gray-100">
                                <tr>
                                    {['Last Seen', 'Full Signature', 'Type', 'Count', 'Status', 'Rule Name', 'Exception Info'].map((header, idx) => (
                                    ...
                                    <tr key={idx} className="group hover:bg-gray-50/50 transition-colors border-l-4 border-l-transparent hover:border-l-[#ee4a4a]">
                                        ...
                                        <td className="px-8 py-5">
                                            <div className="max-w-[150px]">
                                                <p className="text-sm font-bold text-gray-800 truncate" title={row['display_rule']}>
                                                    {row['display_rule']}
                                                </p>
                                            </div>
                                        </td>
                                        <td className="px-8 py-5">
                                            <div className="max-w-[300px]">
                                                <p className="text-sm font-medium text-gray-500 line-clamp-2" title={row['exception_summary'] || row['message_summary']}>
                                                    {row['exception_summary'] || row['message_summary']}
                                                </p>
                                            </div>
                                        </td>
                                    </tr>
